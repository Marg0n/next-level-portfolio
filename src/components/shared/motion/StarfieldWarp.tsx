...
const StarfieldWarp = ({children}: {children: any}) => {
    ...
    return (
        <div
            ref={wrapperRef}
            className="relative w-full min-h-full flex items-center justify-center flex-col overflow-hidden rounded-high bg-transparent"
        >

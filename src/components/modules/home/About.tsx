...
import whoAmI from "@/assets/images/jacky-who-am-i.png";
      ...
      <div className="flex flex-col lg:flex-row gap-12 items-center">
        ...
        <div className="space-y-6 ">
          <p className="text-wrap xl:text-xl text-base" data-aos="fade-up">
            I am a dedicated web developer with experience in creating dynamic
            and responsive web applications.
          </p>
          <p className="text-wrap xl:text-xl text-base" data-aos="fade-up">
            Expert in the <strong className="primary-color">MERN stack</strong>,
            ...
            <br />
            <br />
            My passion for coding provides a profound sense of fulfillment.
            Furthermore, I am eager to expand my knowledge of these technologies
            and explore additional related fields in the future.
          </p>
        </div>
      </div>
    </div>
